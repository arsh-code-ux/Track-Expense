...
export default function SharedFooter() {
  ...
  return (
    <footer className="bg-gradient-to-br from-navy via-primary-900 to-primary-800 text-white pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all transform hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Roadmap</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Press Kit</a></li>
