...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="pt-32 pb-20 px-4 overflow-hidden bg-gradient-to-br from-primary-600 via-purple-600 to-purple-700">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left Content */}
            <div className="space-y-8 animate-fade-in">
              <div className="inline-block">
                <span className="bg-white/20 backdrop-blur-sm text-white px-5 py-3 rounded-full text-lg font-semibold shadow-lg">
                  ✨ Track. Analyze. Save.
                </span>
              </div>
              ...
              <p className="text-2xl text-white/90 leading-relaxed max-w-xl font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  to="/login" 
                  className="btn-darkblue text-lg group inline-flex items-center justify-center"
                >
                  Start Free Today
      ...
      <section id="features" className="py-24 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20 animate-fade-in">
            <span className="text-primary-400 font-semibold text-base uppercase tracking-wider">FEATURES</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              // Assign colors in rotation: primary, purple, cyan, darkblue
              const colorSchemes = [
                { border: 'border-primary-200', hover: 'hover:border-primary-400', gradient: 'from-primary-50/50', text: 'text-primary-600', bgIcon: 'bg-gradient-to-br from-primary-500 to-primary-600' },
                { border: 'border-purple-200', hover: 'hover:border-purple-400', gradient: 'from-purple-50/50', text: 'text-purple-600', bgIcon: 'bg-gradient-to-br from-purple-500 to-purple-600' },
                { border: 'border-cyan-200', hover: 'hover:border-cyan-400', gradient: 'from-cyan-50/50', text: 'text-cyan-600', bgIcon: 'bg-gradient-to-br from-cyan-500 to-cyan-600' },
                { border: 'border-darkblue-200', hover: 'hover:border-darkblue-400', gradient: 'from-darkblue-50/50', text: 'text-darkblue-600', bgIcon: 'bg-gradient-to-br from-darkblue-500 to-darkblue-600' }
              ];
              ...
              return (
                <div 
                  ...
                  className="group relative bg-gray-800 hover:bg-gray-750 p-8 rounded-2xl border border-gray-700 hover:border-primary-500 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/20 hover:-translate-y-2 cursor-pointer"
                ...
                >
                  ...
                  <h3 className="text-2xl font-extrabold text-white mb-4 transition-colors">
                    {feature.title}
                  </h3>
                  <p className="text-lg text-gray-200 leading-relaxed mb-4 font-medium">
                    {feature.description}
                  </p>
                  
                  {/* Click indicator */}
                  <div className={`flex items-center ${scheme.text} text-sm font-semibold`}>
                  ...
                  {selectedFeature === index && (
                    <div className="mt-6 pt-6 border-t border-neutral-200 animate-slide-down">
                      <h4 className="font-extrabold text-white mb-3 text-sm uppercase tracking-wide">Key Features:</h4>
                      <ul className="space-y-2">
                        {feature.details.map((detail, i) => (
                          <li key={i} className="flex items-start text-sm">
                            ...
                            <span className="text-darkblue-700">{detail}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-br from-gray-800 to-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20">
            <span className="text-primary-600 font-semibold text-base uppercase tracking-wider">SIMPLE PROCESS</span>
            <h2 className="text-5xl md:text-6xl font-extrabold text-white mt-4 mb-6">
          ...
          <div className="grid md:grid-cols-4 gap-8 md:gap-6">
            {howItWorks.map((step, index) => (
              <div key={index} className="relative">
                {/* Step Card */}
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-neutral-100 hover:border-primary-500 group">
                  {/* Step Number */}
                  <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl flex items-center justify-center text-white text-3xl font-bold shadow-xl group-hover:scale-110 transition-transform">
                    {step.step}
                  </div>
                  
                  <h3 className="text-2xl font-bold text-black mb-4 text-center group-hover:text-primary-600 group-hover:font-extrabold transition-all">
                    {step.title}
                  </h3>
      ...
      {/* Statistics Section - Modern Counter with Multi-Colors */}
      <section className="py-20 bg-gradient-to-br from-darkblue-700 via-primary-600 to-cyan-600">
        <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, index) => {
              // Assign different colors to each plan: darkblue, purple (popular), cyan
              const planColors = [
                { bg: 'bg-gradient-to-br from-darkblue-50 to-darkblue-100', border: 'border-darkblue-300', text: 'text-white', price: 'text-darkblue-700', button: 'btn-darkblue' },
                { bg: 'bg-gradient-to-br from-purple-600 to-purple-800', border: 'border-purple-400', text: 'text-white', price: 'text-white', button: 'bg-white text-purple-700 hover:bg-purple-50' },
                { bg: 'bg-gradient-to-br from-cyan-50 to-cyan-100', border: 'border-cyan-300', text: 'text-cyan-900', price: 'text-cyan-700', button: 'btn-cyan' }
              ];
              ...
              return (
                <div 
                  ...
                  className={`relative rounded-3xl p-8 transition-all duration-300 ${
                    plan.popular
                      ? 'bg-gradient-to-br from-purple-600 to-purple-800 text-white shadow-2xl scale-105 border-4 border-accent-400'
                      : `${colors.bg} border-2 ${colors.border} hover:shadow-xl hover:scale-[1.02]`
                  }`}
                >
                  {plan.popular && (
                    <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
                      <span className="bg-gradient-to-r from-accent-500 to-accent-600 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse">
                        ⭐ MOST POPULAR
                      </span>
                    </div>
                  )}
                  ...
                  <div className="text-center mb-8">
                    <h3 className={`text-2xl font-bold mb-2 ${plan.popular ? 'text-white' : colors.text}`}>
                      {plan.name}
                    </h3>
                    <div className="flex items-baseline justify-center mb-2">
                      <span className={`text-5xl font-extrabold ${plan.popular ? 'text-white' : colors.price}`}>
                        {plan.price}
                      </span>
                  ...
                  <Link
                    ...
                    className={`block w-full py-4 px-6 rounded-xl text-center font-bold transition-all transform hover:scale-105 ${
                      plan.popular
                        ? 'bg-white text-purple-700 hover:bg-accent-500 hover:text-white shadow-xl'
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="text-lg font-extrabold text-white pr-4 group-hover:text-primary-600 transition-colors">
                    {faq.question}
                  </span>
                ...
                {expandedFaq === index && (
                  <div className="px-6 pb-6 text-darkblue-700 leading-relaxed animate-slide-down border-t border-neutral-100 pt-4">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      {/* CTA Section - Modern & Engaging with New Colors */}
      <section className="py-24 px-4 bg-gradient-to-br from-darkblue-700 via-primary-600 to-purple-700 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 md:p-16 shadow-2xl border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                to="/login" 
                className="bg-white text-darkblue-700 hover:bg-accent-500 hover:text-white px-10 py-4 rounded-xl text-lg font-bold transition-all transform hover:scale-105 shadow-2xl inline-flex items-center group"
              >
