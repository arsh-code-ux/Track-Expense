    ...
    try {
      const response = await fetch(`${API_BASE}/api/savings-goals`, {
        ...
        body: JSON.stringify({
          ...
          currentAmount: 0, // Always start at 0, will use live balance for display
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                  <p>Your savings goal will automatically track your current balance ({formatAmount(currentBalance)}) as the current amount. As you add or remove money, your progress will update in real-time!</p>
                </div>
              </div>
            </div>
          </div>
